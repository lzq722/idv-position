...
import position1 from './positions/1.json'
import position2 from './positions/2.json'
import position3 from './positions/3.json'
import position4 from './positions/4.json'
import position5 from './positions/5.json'
import position6 from './positions/6.json'
import position7 from './positions/7.json'
import position8 from './positions/8.json'
import position9 from './positions/9.json'
